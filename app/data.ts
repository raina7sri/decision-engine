...
export const systemTools = [
  ...
  {id:"decision",name:"GTM Decision Engine",stage:"foundation" as StageKey,status:"Shipped — Open Source",icon:Scale,job:"Compares strategic options against company-specific criteria, weights, true must-meet thresholds, and evidence.",inputs:"Decision question, criteria, weights, options, scores, evidence notes, and optional thresholds",outputs:"Versioned DecisionRecord, readable report, and optional MOS handoff",feeds:"Customer validation and optional Messaging OS adapter",human:"People own criteria, evidence judgment, eligibility requirements, and the final call.",system:"Calculates, blocks false leaders, applies eligibility rules, prepares a deterministic recommendation, persists records, and invalidates stale confirmations.",repositoryUrl:"https://github.com/raina7sri/decision-engine",deploymentUrl:"https://raina7sri.github.io/decision-engine/"},
